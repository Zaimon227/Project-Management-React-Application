            ...
            <div className="form--task-details-container">
                ...
                <div className="form--task-rightside-contents">
                    <div className="form--task-rightside-inner-container">
                        <p className="form--task-details-label">Status:</p>
                        {taskstatus === "todo" && <p className="form--task-details-status">To Do</p>}
                        {taskstatus === "inprogress" && <p className="form--task-details-status">In Progress</p>}
                        {taskstatus === "fortesting" && <p className="form--task-details-status">For Testing</p>}
                        {taskstatus === "done" && <p className="form--task-details-status">Done</p>}
                        {taskstatus === "invalid" && <p className="form--task-details-status">Invalid</p>}
